...
gem 'content_filters', git: 'https://github.com/patchwork-hub/content_filters', branch: 'mastodon-4.5.6-delay'
...
gem 'local_only_posts', git: 'https://github.com/patchwork-hub/local_only_posts', branch: 'mastodon-4.5.6-delay'
