...
gem 'accounts', git: 'https://github.com/patchwork-hub/accounts', branch: 'mastodon-4.5.6-NM-1756'
gem 'content_filters', git: 'https://github.com/patchwork-hub/content_filters', branch: 'mastodon-4.5.6-NM-1756'
gem 'conversations', git: 'https://github.com/patchwork-hub/conversations', branch: 'mastodon-4.5.6'
gem 'custom_feeds', git: 'https://github.com/patchwork-hub/custom_feeds', branch: 'mastodon-4.5.6-NM-1756'
gem 'local_only_posts', git: 'https://github.com/patchwork-hub/local_only_posts', branch: 'mastodon-4.5.6'
