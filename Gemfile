...
gem 'accounts', git: 'https://github.com/patchwork-hub/accounts', branch: 'mastodon-4.5.5-ghost-integration'
...
gem 'posts', git: 'https://github.com/patchwork-hub/posts', branch: 'mastodon-4.5.5-ghost-integration'
